...
<title>PropertyWeb - Deal Analysis</title>
    ...
    <link href="/dealanalysis/resumen/tabla2.css" rel="stylesheet" type="text/css">
...
<div class="container">
	<section id="s_buscador" class="row">
		...
		<div class="col-md-4 lateral">
			<div class="caja sombra"><!--#include virtual="/dealanalysis2/resumen/tabla.asp" --></div>
		</div>
		
		<div class="col-md-8">
<form name="frm_deal" id="frm_deal" method="post" action="/dealanalysis2/resultados/resultados.asp" target="_blank" autocomplete="off" class="form-horizontal row">
