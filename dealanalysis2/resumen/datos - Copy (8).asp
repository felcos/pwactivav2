...
sql = sql & "(OPERACIONES.FECHA_PUBLICACION BETWEEN CONVERT(DATETIME, '2021-03-01 00:00:00', 102) AND CONVERT(DATETIME, '2021-04-01 00:00:00', 102)) AND "
...
<% function CalculaMEuros(p_op, p_sec, p_year, p_zona)
	...
	sql = sql & "(FECHA_PUBLICACION BETWEEN CONVERT(DATETIME, '2021-03-01 00:00:00', 102) AND CONVERT(DATETIME, '2021-04-01 00:00:00', 102)) AND "
