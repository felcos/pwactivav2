...
case ""
	...
	if request("provincia")="2" then
		...
		sqlW = sqlW & " ( web_es=1 and  (ID_PROVINCIA<>3 AND ID_PROVINCIA<>2) )  AND (id_region IN (1, 2, 3, 5)) AND (ID_PROVINCIA <> 0) and "
	else
...
case "0"
		sqlW = sqlW & " (ID_PROVINCIA<>3 AND ID_PROVINCIA<>2) AND "
