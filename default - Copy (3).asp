  ...
  <section id="slogan" class="row  clearfix slogan"  >
    <div class="" style="margin-top:6px; margin-bottom: 0px;">
      ...
      <img src="/img/imagotipo_naran.png" class="imago"><span style="color:#2b4e61;font-size:18px;">PW</span> es el registro no oficial de las transacciones en el mercado inmobiliario terciario de Espa&ntilde;a desde 1990.<br />
       <img src="/img/imagotipo_naran.png" class="imago"><span style="color:#2b4e61;font-size:18px;">PW</span> es el registro de propietarios, edificios, centros comerciales, hoteles, etc... con un histórico con gráficos, etc... desde 1990. </div>
    </div>
  </section>
  <section id="graficas" class="clearfix">
  ...
  <section id="resumen" class="row">
    ...
    <div class="col-md-4">
      <div class="inversores">
        <h2 class="" >Inversores m&aacute;s activos <span style="float:right;">a&ntilde;o 2017</span></h2>
...
<a href="https://www.joneslanglasalle.es" target="_blank"><img src="/img/banners/jll.gif" alt="Jones Lang Lasalle" style="width:150px; margin:auto 30px;"></a>
...
<a href="https://www.realestate.bnpparibas.es" target="_blank">	<img src="/img/logos/bnp.gif" alt="BNP Paribas Real Estate" style="width:150px; margin:auto 30px;"></a>
