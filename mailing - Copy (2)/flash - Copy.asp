...
<img src="/img/imagotipo_naran.png" style="position:relative;bottom:9px;left:3px;"><span style="color:#2b4e61;font-size:18px;">PW</span> es el registro de propietarios, edificios, centros comerciales, hoteles, etc... con un histórico con gráficos, etc... desde 1990.
        </td>
    </tr>
</table>
			</td><!--2 :: -->
