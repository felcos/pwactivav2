...
<table width="100%"  border="0" cellpadding="0" cellspacing="0"  ><!-- interior-->     
    ...
    do while not resultado.EOF
        ...
        <tr><!-- artículo -->
            ...
            <td class="enlace"><a href="<%= enlace %>" target="_blank"><img src="<%=sFotoN %>" width="25" style="vertical-align:top;border-radius: 3px 3px 3px 3px;box-shadow: 2px 2px 10px #666;width:25;max-width:25; margin: 0px 0px 0px 0px;"/>&nbsp;&nbsp;&nbsp;<% Titulo(resultado) %></a></td>
        </tr>
        <% resultado.movenext
    loop %>
	<% end if
