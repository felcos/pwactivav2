...
<img src="/img/imagotipo_naran.png" style="position:relative;bottom:9px;left:3px;"><span style="color:#2b4e61;font-size:18px;">PW</span> es el registro de propietarios, edificios, centros comerciales, hoteles, etc... con un histórico con gráficos, etc... desde 1990.    <br>
<img src="/img/imagotipo_naran.png" style="position:relative;bottom:9px;left:3px;"><span style="color:#2b4e61;font-size:18px;">PW</span> <a href="https://youtu.be/fTJR6LQC8gI">Ver el video del dia 16/02/2018 GRATIS!</a>    
...
<table width="100%" bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" class="bloque" >
     ...
     <img src="/_inc/javier/mailing/boloH1.gif"  /> Actualidad 
     </caption>
     <tr>
