    ...
    <input type="hidden" name="frmAdminLogin" value="registro">
        <table border="0" cellpadding="4" align="center">
		  ...
		  <tr>
            ...
            <td colspan="4"><input type="tlf" name="telefono" maxlength="30" size="52" value="" class="form-control" required="required"></td>
          </tr>
          <tr>
...
$(document).ready(function() { 
	...
	function testForm(){
		...
		if (document.frm_registro.telefono.value=="") {ErrSubmit="<p class='destaca'>Tienes que introducir un número de teléfono.</p>"};
