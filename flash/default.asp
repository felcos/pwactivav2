...
<!--#include virtual="/activa-v2/inc/layout/header-v2.asp" -->
    ...
    <main class="av2-wrapper" style="max-width: 1200px; margin: 40px auto; padding: 0 20px;">
        <div style="margin-bottom: 30px;">
            <h1 style="font-size: 2.2rem; font-weight: 800; color: var(--text-primary); margin-bottom: 10px;">Daily Flash</h1>
            <p style="color: var(--text-muted); font-size: 1.1rem;">Resumen diario de mercado</p>
        </div>
        <section id="fechas" class="fechas row">
            <div class="col col-md-12 caja clearfix">			
                
                <a href="https://www.dracorion.com/" target="_blank" ><img src="publi1.png" width="200"  style="margin:0px;padding:0px;margin-left: 0px;"  /></a>
 
                <a href="https://www.simmons-simmons.com/" target="_blank" ><img src="/img/simmons.gif" width="200"  style="margin:0px;padding:0px;" /></a>            
                <a href="https://www.catella.com/" target="_blank" ><img src="BannerPW.png" width="200" style="margin:0px;padding:0px;"   /></a>
		<a href="https://inmobiliaria.cushmanwakefield.es/" target="_blank" ><img src="/img/Cus.png" width="200" style="margin:0px;padding:0px;"   /></a>
		<a href="https://www.gleeds.com/en/" target="_blank" ><img src="/img/gleeds.gif" width="200" style="margin:0px;padding:0px;"   /></a>

            </div>
        </section>

        <!-- Modulo de Inteligencia Artificial (Briefing Diario Agente 2) -->
