<% sub VerEstudio(byRef pRS) 
	'insert_reg_articulo "est", pRS("ID") %>
<a name="est<%= pRS("ID") %>" id="est<%= pRS("ID") %>"></a>
...
<% if strLinkExterno<>"" then 
	'if len(strLinkExterno)>45 then strLinkExterno = left(strLinkExterno, 45) & "..."
%>
<span>Abrir Informe Completo</span><br>
<table width="100%" border="0" cellspacing="0" cellpadding="2" align="center" >
<tr> 
	<td class="txtTabla"><a href="<%= strLinkExterno %>" target="_blank"><img src="/img/export.gif" border="0"/></a></td>
	<td class="txtTabla"><a href="<%= strLinkExterno %>" target="_blank"><%= strTextoLink %></a></td>
