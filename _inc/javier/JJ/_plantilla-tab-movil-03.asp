...
<link rel="stylesheet" type="text/css" href="../../../css/css-pags/tabs-menuDcha.css">
...
<a id="verSubmenu" href=""  class="visible-xs btn bt_lupa" ><span class="icon-search"></span></a>
  <!-- Nav tabs -->
  ...
  <!-- 
    ...
    z-index: 1000;-->
      ...
      <!-- Nav tabs -->
      <ul class="nav nav-tabs clearfix  hidden-xs lineNavs">
        <li class=""><a href="#busqueda" data-toggle="tab" aria-expanded="false"><span class="icon-search"></span> Busqueda</a></li>
        <li class="active"><a href="#registros" data-toggle="tab" aria-expanded="true"><span class="icon-file-text2"></span> Registro</a></li>
        <li style="
    display: none;
...
<!-- Tab panes -->
      <div class="tab-content">                
             ...
             <div class="tab-pane active" id="registros"> <!--     02 -->
