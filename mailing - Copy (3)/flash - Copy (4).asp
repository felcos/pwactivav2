...
<table width="100%" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
    ...
    <tr>
        <td align="left" style="font-size:16px; line-height:1.6em;padding-left: 16px;padding-top: 10px;padding-bottom: 10px; border-bottom: 1px solid #efefef;" colspan="2">
...
<tr>
<td>
<a href="https://youtu.be/<%= xvideo("link") %>"><img src="Video02.png" ></a>   
<br><span style="color:#2b4e61;font-size:18px;">Andy da las calves de Hoy en vivo!</span>
</td>
<td>
