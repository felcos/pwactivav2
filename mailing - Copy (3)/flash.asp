...
<br>
 ...
 <td>
  <a href="https://www.hollisglobal.com/?utm_source=Property%20Web&utm_medium=Link&utm_campaign=Advert" target="_blank" ><img src="mh.png" align="right"/></a> 
  <br>
 </td>
...
<table width="100%" bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" class="bloque" >
    <caption align="top" style="font-size:21px; color:#FF6802; text-align:left; font-family:Verdana, Geneva, sans-serif">
        <img src="/_inc/javier/mailing/boloH1.gif"  /> Ops Inversión publicadas en septiembre </caption>
    <tr>
...
<table width="100%" bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" class="bloque" >
    <caption align="top" style="font-size:21px; color:#FF6802; text-align:left; font-family:Verdana, Geneva, sans-serif">
        <img src="/_inc/javier/mailing/boloH1.gif"  /> Ops Alquiler publicadas en septiembre </caption>
    <tr>
