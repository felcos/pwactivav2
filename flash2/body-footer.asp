...
<div class="row comunicacion"> <!-- * comunicacion  -->
    ...
    <form id="footer_suscribe">
    <div class="input-group">
      <input name="email" type="email" class="form-control" placeholder="Escribe tu mail aquí" required="required" autocomplete="off" id="footer_suscribe_email">
