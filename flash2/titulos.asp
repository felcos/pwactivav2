...
'**************** fin proceso automatico
	...
	sql_vencim = sql_vencim & "AND web_es <> 0 "
        ...
        <% if 1=1 then %>
        <h2 class="tit_box"><span class="icon icon-arrow-down-right2"></span>Ops Inversión publicadas en septiembre</h2>
        <div class="box_blanco">
            <div  style="align-content: center;"><a href="/dealanalysis/"><!--#include virtual="/flash2/USO.htm" --></a></div>
        </div>
        <h2 class="tit_box"><span class="icon icon-arrow-down-right2"></span>Ops Alquiler/Traspaso publicadas en septiembre</h2>
        <div class="box_blanco">
