...
<head>
	...
	<!--#include virtual="/flash2/head.asp" -->
    <link href="/flash2/flash.css" rel="stylesheet" type="text/css"/>
...
<!--#include virtual="/inc/body-header.asp" -->
  ...
  <div class="flex container">
                ...
                <div class="col-md-6 caja "  >
                    ...
                    <div id="divMetodoToggleV" style="display:inline-block;">
                        ...
                        <div style="background: none repeat scroll 0 0 #FFFFFF;
                                ...
                                width: 90px;
                                z-index: 15;"> 
                                <img src="/fotos/andy02.jpg" width="56px" style="vertical-align:top;border-radius: 3px 3px 3px 3px;box-shadow: 2px 2px 10px #666;"/>
                            </div>
                ...
                <div class="col-md-6 caja "  >
                        ...
                        <a href="https://www.dracorion.com/" target="_blank" ><img src="publi1.png" width="300" align="center" style="margin:0px;padding:0px;margin-left:0px;" /></a>
                        <a href="https://track.adform.net/C/?bn=31376437" target="_blank"><img align="right" src="/img/300x150_terciario_industrial.gif"  width="300" style="margin:0px;padding:0px;" ></a>
                        <a href="https://www.hollisglobal.com/?utm_source=Property%20Web&utm_medium=Link&utm_campaign=Advert" align="right" target="_blank" ><img src="/img/banners/mh.png"  width="300"  style="margin:0px;padding:0px;"   /></a> 
                
                        <a href="https://www.catella.com/" target="_blank" ><img src="BannerPW.png" align="right"  width="300" style="margin:0px;padding:0px;"  /></a>
                ...
                <div class="col-md-5 caja " >		
                    ...
                    <h4>Y si tienes algo para nosotros, llamame... Movil:617.835.023 o andyg@propertyweb.eu</h4>
        ...
        <div class="row">
            <div class="col-md-6">
            <div class="caja clearfix"  style="width: 48%;">
                <h1 class="heading PWsemana aMetodoToggle3" ><span class="icoLogo"></span>Mas Time4aChange<span class="icon icon-arrow-down2"></span>
                </h1>
                <div>
