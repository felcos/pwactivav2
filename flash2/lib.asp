...
<div class="bloque">
    <% do while not resultado.EOF
        ...
        %>
<div class="articulo" ><input type="checkbox"    name="<%= strin %>" value="<%= resultado("id") %>" ><a href="<%= enlace %>" class="simplemodal"><img src="<%=sFotoN %>" width="25" hspace="1" vspace="1" style="vertical-align:top;border-radius: 3px 3px 3px 3px;box-shadow: 2px 2px 10px #666;width: 25;max-width: 25; margin: 0px 0px 0px 0px;"/>&nbsp;&nbsp;&nbsp;<% Titulo(resultado) %></a></div>
        <% resultado.movenext
    loop %>
</div>
<% end sub %>
