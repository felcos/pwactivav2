<p style="font-family:'ruda',sans-serif; font-size:15px; font-weight:bold;">Transacciones Registradas en Espa&ntilde;a</p>
<%
r_year = request.Form("resumen_y")
'if r_year = "" then r_year = year(date)
if r_year = "" then r_year = 2018
if request.Cookies("dev")<>"" then r_year = 2015
...
<input type="hidden" name="resumen_zona" value="es" />
