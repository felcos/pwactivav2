...
<div class="row">
    <div class="col-md-6">
        ...
        <h2 class="tit_box"><span class="icon icon-arrow-down-right2"></span>PW News Summary <img src="https://www.propertyweb.eu/rrss/gratis1.png" width="44px"  /> </h2>
        <% 'Actualidad	
        bloque="not"
        strin="not"
        ErrMesage=""
        ...
        <h2 class="tit_box"><span class="icon icon-arrow-down-right2"></span>Ofertas</h2>
        <%' Ofertas	
        bloque="ofe"
        strin="ofe"
        ErrMesage=""
    ...
    <div class="col-md-6">
        ...
        <h2 class="tit_box"><span class="icon icon-arrow-down-right2"></span> Time4aChange<img src="https://www.propertyweb.eu/img/logos/logoT4AC.png" width="45" align="right"></h2>
...
sql = "SELECT * FROM View_Time4Change WHERE (fecha >= CONVERT(DATETIME, '" & pFecha & "', 103))"
        ...
        %>
        <% if not resultado.eof then %>
        <div class="box_blanco"><% call BloqueTitulosT4ac() %></div>
        <% end if
        resultado.close %>
