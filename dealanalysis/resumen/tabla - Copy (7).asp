...
if r_year = "" then r_year = 2020
if request.Cookies("dev")<>"" then r_year = 2020
...
%>
<form style="background-color:lightsteelblue;" id="frm_resumen" name="frm_resumen" action="" method="post" autocomplete="off" target="_blank">
...
<div id="tabla_resumen" style="border: lightsteelblue;border-style:outset;border-spacing: 3px;"><img src="/img/camera-loader.gif" style="margin: 24px;"/></div>
