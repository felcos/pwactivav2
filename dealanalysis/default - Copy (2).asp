...
%>
    ...
    %>
      <div class="form-group clearfix">
        ...
        <div class="col-sm-8">
        <input type="text" name="vendedor" id="vendedor" size="30" class="form-control"  value="<%= r_vendedor %>" onChange="$('#frm_deal').submit();">
        </div>
      </div> <!-- fin form-group-->
      <div class="form-group clearfix">
        <label for="comprador"  class="col-sm-4 control-label ">Comprador/Inquilino:</label>
         <div class="col-sm-8">
        <input type="text" name="comprador" id="comprador" size="25" class="form-control"  value="<%= r_comprador %>" onChange="$('#frm_deal').submit();">
        </div>
      </div> <!-- fin form-group-->
      <div class="form-group clearfix">
        <label for="intermediario"  class="col-sm-4 control-label ">Intermediario:</label>
         <div class="col-sm-8">
        <input type="text" name="intermediario" id="intermediario" size="25" class="form-control"  value="<%= r_intermediario %>" onChange="$('#frm_deal').submit();">
        </div>
      </div> <!-- fin form-group-->
    </div>
