...
''	end if 
	...
	%>
<div class="dispA" data-id="<%= rsBusq("id") %>" <% if xEnConstruccion then  %> style="background-color:#eeeeee;" <% end if 
	 %>
	>
        ...
        <table class="tbDispon">
            <tr>
				<td class="tbDisp-Plta">
					<% if xEnConstruccion then   %> <img src="/img/underc.png" width="21"/> <% end if 
					%>
				</th>
