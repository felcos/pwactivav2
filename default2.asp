      ...
      <div class="row visto">
        <div class="col-md-9">
          <div class="cajaInterior" style="background-image: linear-gradient(to right, #011e46 , #2b4e78);">
            <iframe src="/informe_takeup/defaultm.asp" style="border: 0px;background-image: linear-gradient(to right, #011e46 , #2b4e78);" width="810px" height="416px" scrolling="No" ></iframe>
        ...
        <div class="col-md-3">
          <div class="cajaInterior" style="background-color:#dce3e8;">
            ...
            <iframe src="/informe_takeup/donut04m.asp" style="border: 0px;background-color: #dce3e8;;" width="240px" height="208px" scrolling="No" ></iframe>
        ...
        <div class="row visto">
          <div class="col-md-9">
            <div class="cajaInterior" style="background-image: linear-gradient(to right, #091e36 , #2a5788);">
              <iframe src="/informe_takeup/defaultb.asp" style="border: 0px;background-image: linear-gradient(to right, #091e36 , #2a5788);" width="810px" height="416px" scrolling="No" ></iframe>
            
            </div>
          </div>
          <div class="col-md-3">
            <div class="cajaInterior" style="background-color:#dce3e8;">
              <iframe src="/informe_takeup/donut04b.asp" style="border: 0px;background-color: #dce3e8;" width="240px" height="208px" scrolling="No" ></iframe>
...
<a href="/pw/contacto.asp"><img src="/img/baner_tv_220x.jpg" style="margin:auto 15px;"></a>
 	...
 	<div class="row">
    			...
    			<a href="https://segro-los-gavilanes.330e.brandcast.io/" > <img src="/img/banner-segro-1200x80.jpg" class="imago">
...
<a href="https://www.malcolmhollis.com/" target="_blank"><img src="/img/banners/mh.png" alt="Malcolm Hollis" style="width:150px; margin:auto 30px;"></a>
...
<a href="https://www.gleeds.com" target="_blank"><img src="/img/logos/gleeds.png" alt="Gleeds" style="width:150px; margin:auto 30px;"></a>
        </div>
    </div>
</section>
