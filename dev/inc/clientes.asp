<% if request.QueryString("id_cliente")="" then %>
    ...
    <div class="panel panel-danger">
        <div class="panel-heading"><h4 class="panel-title">dev - SET licencia <% if request.Cookies("licencia")<>"" then %><a href="/dev/bin/set_licencia.asp?act=del" target="_blank" class="pull-right peq">DEL COOKIE</a><% end if %></h4></div>
...
loop %>
    ...
    <div id="recibe_licencias"></div>
        ...
        <div class="panel-footer">
        	<li>set licencia: <a href="/dev/bin/set_licencia.asp?act=set&n=pablo.propertyweb@gmail.com&u=PW&p=TIPS&client_id=1&user_id=1" class="licencia" target="_blank">pablo.propertyweb@gmail.com</a></li>
        	<li>set licencia: <a href="/dev/bin/set_licencia.asp?act=set&n=pablo.propertyweb@gmail.com&u=PW&p=BD&client_id=1&user_id=1" class="licencia" target="_blank">get BD</a></li>
        </div>
    </div>
    <%
    rsClientes.close
...
<% elseif request.QueryString("id_cliente")<>"" then
    ...
    <tr data-id="<%= url %>" class="dev_fila">
		...
		<td class="peq"><a href="/dev/bin/set_licencia.asp?act=set&<%= url %>" class="licencia" target="_blank"><%= nombre %></a></td>
