...
case "set"
	...
	response.cookies("licencia")("n") = n	'session("PW_WS").Licencia
	response.cookies("licencia")("u") = u	'session("PW_WS").Cliente
	'if movil<>"" then
	...
	response.cookies("licencia")("user_id") = user_id	'session("PW_WS").LicenciaId
