	...
	<div id="containerHeader" class="row">
		<header class="containerHeader clearfix">
			...
			<div class="col-sm-9 izquierda">
				<div class="row">
					<!--logoPW-->
					<div class=" col-sm-12 col-md-5 logoPW">
						...
						<div class="aboutUs">
							<ul>
								<li class="li-movil"><a href="/flash/" class="PWhoy"><img src="/img/shared/newsPaper.png"/><p><span class="icoLogo"></span>PW Hoy - Semana</p></a></li>
						...
						<div class="row buscadores">
								...
								<form action="<%= url %>" method="post" id="frmInfo">
									<ul>
										...
										<li>
											...
											<label for="frmInfo_cc" id="lblInfo_cc" class="lblInfo <% if frmInfo_tipo="cc" then %>activo<% end if %>"><span class="icon-coin-euro"></span> Centro Comercial<% if ver_contadores then %> <span data-toggle="contador_leidos" data-content="cc"><%= ubound(filter(ArticulosLeidos, "cc"))+1 %></span><% end if %></label>
							...
							<div class="col-sm-6 colBusqueda" id="head_div_busq">
								...
								<ul>
									...
									%></li>
									<li><a href="/actualidad/">Actualidad <% if not ver_contadores2 then %>Inmobiliaria<% else %>Inmob&hellip;<% end if %></a><% if ver_contadores2 then %><span data-toggle="contador_leidos" data-content="not"><%= ubound(filter(ArticulosLeidos, "not"))+1 %></span>/<span data-toggle="contador_leidos" data-content="rum"><%= ubound(filter(ArticulosLeidos, "rum"))+1 %></span><% end if %><% 
			...
			<div class="col-sm-3 derecha">
				...
				<div class="user hidden-xs">
					<ul>
						...
						<li><span class="icon-user-tie"></span> Tu gestor:
							<p>Patricia Conde<% if 1=2 then%> Salazar<% end if %></p>
						</li>
						<% else	'dev %>
						<li class="informa">
				...
				<div class="contact">
					<ul>
						...
						<li><a href="javascript:void(0);"><img src="/img/shared/realPartner.png" alt="Real Capital Analytics" class="img_rca"></a></li>
