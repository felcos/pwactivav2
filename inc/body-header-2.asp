...
if frmInfo_tipo="" then
	'Response.Write("pasa por aqui..." + frmInfo_tipo)
			...
			<div class="col-sm-3 derecha">
				...
				<div class="contact">
					<ul>
						...
						<li class="tlf hidden-xs"><span class="icon-phone"></span> 617 835 023</li>
						<li class="hidden-xs"><a href="mailto:pw@propertyweb.eu"><span class="icon-mail4"></span> E-mail</a></li><br>
