...
sqlvideo = "SELECT * FROM VideosList ORDER BY fecha DESC"
...
<!--#include virtual="/inc/body-header.asp" -->
  ...
  <div class="container">
	...
	<div class="caja clearfix">
	    ...
	    <iframe src="//<%= xvideo("link") %>" width="300"  allowfullscreen="allowfullscreen"></iframe>
	...
	<div class="caja clearfix">
          ...
          <div id="divMetodoToggle2" style="display:none;">
            ...
            <iframe src="//www.youtube.com/embed/6joFpR3Dfdo" width="300"  allowfullscreen="allowfullscreen"></iframe>
            <iframe src="//www.youtube.com/embed/pgM7rSR3r0o" width="300"  allowfullscreen="allowfullscreen"></iframe>
