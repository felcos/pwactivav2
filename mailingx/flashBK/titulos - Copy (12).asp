...
pFecha4 = DateAdd("m",-1,pFecha)
pFecha5 = DateAdd("m",2,pFecha)
...
''''PROCESO AUTOMATICO VENCIMIENTOS DE CONTRATO
	...
	set procesoven4 = Server.CreateObject("ADODB.Recordset")
        ...
        sql_vencim = "UPDATE TOP (10) OPERACIONES SET FECHA_PUBLICACION_VENCIMIENTO=CONVERT(DATETIME, '" & pFecha & "', 103) "
        sql_vencim = sql_vencim & "WHERE (FECHA_PUBLICACION_VENCIMIENTO>=CONVERT(DATETIME, '" & pFecha & "', 103)) AND  "
	...
	if procesoven2.eof then 
		...
		sql_vencim = "update OPERACIONES set FECHA_PUBLICACION_VENCIMIENTO = DateAdd("m",2,GETDATE() ) "
	...
	procesoven3.close 
	procesoven4.close 
'FIN PROCESO AUTOMATICO VECIMIENTOS DE CONTRATO
