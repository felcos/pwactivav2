...
sql = sql & "(ID_TIPO_OPERACION=1 OR ID_TIPO_OPERACION=3) AND (seccion LIKE '%naves industriales%') AND (ID_PROVINCIA=18) "
sql = sql & "AND METROS_CUADRADOS>=15000 AND FECHA_OPERACION >= CONVERT(DATETIME, '01/01/2015', 103) AND web_es<>0 ) "
...
<p><%'= sql %>
GUADALAJARA &nbsp; // &nbsp; tipo = VENTA / OCUPACI&Oacute;N PROPIA &nbsp; // &nbsp; Superf. >= 15.000 M&sup2; &nbsp; // &nbsp; Fecha Ops.: 01/01/2015 - 16/06/2015</p>
<table width="100%">
<tbody>
<thead>
<tr>
