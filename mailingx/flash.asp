...
<table width="100%" bgcolor="#f7f7f7" border="0" cellpadding="0" cellspacing="0">
  ...
  <td align="center">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="width: 100%; max-width: 970px;">
        <tr>
            <td><!--1-->
            	<img src="/_inc/javier/mailing/cabecera-xxxx.jpg" usemap="#cabecera" border="0" /><!--cabecera-sin.gif -->
            </td>
</tr>
...
<tr>
<td colspan="3">
<a href="https://youtu.be/<%=xxvideo("link") %>"><img src="video03.png" hspace="20" ></a>   
<br>
