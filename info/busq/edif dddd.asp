...
if Not IsNull(rsBusq("fecha_renov")) then c_fecha_renov = rsBusq("fecha_renov") else  c_fecha_renov = 0 end if
...
<% function calcular_sql()	
	...
	case else			'rtipo	
		...
		case 2	'inmuebles, semejante ó Dir. exacta	
			...
			sql_datos = "SELECT id, nombre_calc, lat,lng FROM dirs_w_inmuebles WHERE " & sqlw & " AND lat IS NOT NULL  AND lng IS NOT NULL"
