...
<div class="dispA" data-id="<%= rsBusq("id") %>" <% if c_fecha_edif>10000 or c_fecha_renov>10000  then 
	if c_fecha_edif>ActualYYYY2 or c_fecha_renov>ActualYYYY2 then  %> style="background-color:#eeeeee;" <% end if 
	else 
	if c_fecha_edif>ActualYYYY or c_fecha_renov>ActualYYYY then  %> style="background-color:#eeeeee;" <% end if 
	end if %>
	>
    ...
    <div class="dispA-direccion" style="background-color:#f0f8ff;" onmouseover="this.style.backgroundcolor='#FED596';"  ><%= c_nombre %> <span class="numcalle"><%= c_numcalle %></span><% if request.Cookies("dev")<>"" then %> [<%= rsBusq("id") %>]<% end if %></div> 
        ...
        <table class="tbDispon">
            <tr>
				<td class="tbDisp-Plta">
					...
					if c_fecha_edif>ActualYYYY2 or c_fecha_renov>ActualYYYY2 then  %> <img src="/img/underc.png" width="21"/> <% end if 
					else 
					if c_fecha_edif>ActualYYYY or c_fecha_renov>ActualYYYY then  %> <img src="/img/underc.png" width="21"/> <% end if 
					end if %>
				</th>
