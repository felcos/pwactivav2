...
set rsBusq1 = Server.CreateObject("ADODB.Recordset")
dim sql_edif 
sql_edif="select * FROM dirs_w_inmuebles WHERE "
%>
...
Session("xUser")=Request.Cookies("xUser")
 ...
 %>
    ...
    sql_edif=sql_edif & " id=" & pRS("ID_EDIFICIO")
    ID_EDIFICIO=pRS("ID_EDIFICIO")
    rsBusq1.Open sql_edif, session("connPW")
    Nombre_Edificio=rsBusq1("nombre_calc")
    'response.write(Nombre_Edificio)
    'response.write(sql_edif)
    'response.write(" id=" & pRS("ID_EDIFICIO"))
    id_tipo_inmueble=rsBusq1("id_tipo_inmueble")
    'response.write(" id=" & id_tipo_inmueble)
    if id_tipo_inmueble<>NULL and IsNumeric(id_tipo_inmueble) and id_tipo_inmueble<>0 then
        if id_tipo_inmueble=1 then
            id_t_e_def="centro"
            id_t_e_def2="centro"
        end if
        if id_tipo_inmueble=2 then
            id_t_e_def="hotel"
            id_t_e_def2="hotel"
        end if
        if id_tipo_inmueble=0  then
            id_t_e_def="edif"
            id_t_e_def2="edificio"
        end if
        formulario="<form class=&quot;pagsum_detalle&quot; id=&quot;frmComplejo&quot; method=&quot;post&quot; action=&quot;/info/" & id_t_e_def2 &"/&quot;>"
            formulario=formulario & "<input type=&quot;hidden&quot; name=&quot;seltipo&quot; value=" &  id_t_e_def & ">"
            formulario=formulario & "<input type=&quot;hidden&quot; name=&quot;id_edificio&quot; value=&quot;" & ID_EDIFICIO & "&quot;>"
            formulario=formulario & "<input type=&quot;hidden&quot; name=&quot;secc&quot; value=&quot;/info/&quot;>"
            formulario=formulario & "                <!--" 
            formulario=formulario & "        <input type=&quot;hidden&quot; name=&quot;edificio&quot; value=&quot;" & rsCompl("nombre") & "&quot;>"
            formulario=formulario & "        <input type=&quot;hidden&quot; name=&quot;calle&quot; value=&quot;" & rsCompl("nombre_calle") & "&quot;>"
            formulario=formulario & "        <input type=&quot;hidden&quot; name=&quot;numerocalle&quot; value=&quot;" &  rsCompl("numero_calle") & "&quot;>"
            formulario=formulario & "        <input type=&quot;hidden&quot; name=&quot;d&quot; value=&quot;" &  rsCompl("dir1") & "&quot;>"
            formulario=formulario & "        <input type=&quot;hidden&quot; name=&quot;l&quot; value=&quot;" &  rsCompl("localidad") & "&quot;>"
            formulario=formulario & "        -->"
...
<script type="text/javascript">
    ...
    $crisp.push(["do", "message:show", ["text", " Hello, Can I help?"]])
