...
<section id="s_titulo" class="cf">
	<div class="grid-full titulo">
    	...
    	<h2>Inversi&oacute;n/Ocupaci&oacute;n propia</h2>
	</div>
</section>
...
<p>
<input type="hidden" name="op" id="op" value="venta">
...
<label>M. Euros<input type="radio" name="var" value="eur" <% if r_var="eur" then %>checked<% end if %> onClick="$('#frm_graf').submit();"/></label>
</p>
