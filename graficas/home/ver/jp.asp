...
<section id="introp" class="cf">
  <div class="grid-4">
    ...
    <div class="grid-2 grid-flow-opposite">
        Mercado de Oficinas
        <ul>
            <li><a href="/graficas/home/g01.js" class="loadgraf">Rentabilidad</a></li>
            <li><a href="/graficas/home/g02.js" class="loadgraf">Take Up</a></li>
            <li><a href="/graficas/home/g03.js" class="loadgraf">Renta Prime</a></li>
            <li><a href="/graficas/home/g04.js" class="loadgraf">Distribuci&oacute;n por &Aacute;reas - Madrid</a></li>
            <li><a href="/graficas/home/g05.js" class="loadgraf">Distribuci&oacute;n por &Aacute;reas - Barcelona</a></li>
        </ul>
        Mercado de Vivienda Residencial
        <ul>
            <li><a href="/graficas/home/g06.js" class="loadgraf">Espa&ntilde;a</a></li>
        	<li><a href="/graficas/home/g07.js" class="loadgraf">Evoluci&oacute;n del Precio</a></li>
            <li><a href="/graficas/home/g09.js" class="loadgraf">Compraventa - operaciones a julio de cada a&ntilde;o</a></li>
        </ul>
        Mercado de Centros Comerciales
        <ul>
            <li><a href="/graficas/home/g08.js" class="loadgraf">Rentabilidad</a></li>
        </ul>
    ...
    <div class="grid-4">
    	<div id="para_ver" style="width:90%;"></div>
    </div>
...
$(document).ready(function () {
	...
	*/
	...
	$('.loadgraf').click(function(e) {
		var href=this.href;
		$("#para_ver").html('<div id="graf_titulo"></div><div id="graf_subtitulo"></div><div id="graf"></div><div id="graf_fuente"></div>')
