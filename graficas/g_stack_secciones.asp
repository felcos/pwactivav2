...
fecha_i = request.QueryString("FechaI")
if fecha_i="" then fecha_i=1996
fecha_f = request.QueryString("FechaF")
if fecha_f="" then fecha_f=2014
cols = fecha_f - fecha_i

r_var = request.QueryString("var") 
r_op = request.QueryString("op")
r_zona = request.QueryString("zona")
n_fila = 0
