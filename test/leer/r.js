    ...
    var d = document,
        ...
        refreshCss = function(disable){
            ...
            if(disable){
                ...
                var t = ifrm.document.createTextNode("(function(){var script=document.createElement('script');script.setAttribute('src','https://responsive.victorcoulon.fr/assets/js/cssrefresh.js');script.setAttribute('id','cssrefresh');var head=document.getElementsByTagName('head');head[0].appendChild(script)})()"),
