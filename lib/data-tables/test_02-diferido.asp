...
<form id="frm" name="frm" action="/lib/data-tables/data_02.asp" method="post" autocomplete="off" target="_blank">
	<input type="text" name="Fecha" id="Fecha" value="17/06/2015" maxlength="10" class="fecha" required>
    ...
    titulos: <input name="titulos" type="checkbox" value="ver">
...
$(document).ready(function() {
	$('#frm').submit(function(){
		...
		tbl1 = $('#example').DataTable({
			...
			"ajax": {
				"type": "POST",
				"url": "/lib/data-tables/data_02.asp",
				"data": $("#frm").serialize()
			}
