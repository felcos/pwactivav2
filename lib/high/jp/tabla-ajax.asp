...
sql = "SELECT ID, EMPRESA, NOMBRE_EMPRESA, NUM_LICENCIAS, LICENCIAS_ENVIADAS FROM PW_clientes WHERE id>2 AND ACTIVO=1"
...
%>
<tr>
    <th id="uid<%= rs("id") %>"><%= rs("id") %></th>
    <th><%= rs("nombre_empresa") %></th>
    <td><%= rs("empresa") %></td>
