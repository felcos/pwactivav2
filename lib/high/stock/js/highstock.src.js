...
defaultOptions = {
	...
	global: {
		useUTC: true,
		//timezoneOffset: 0,
		canvasToolsURL: 'https://code.highcharts.com/stock/2.0.4/modules/canvas-tools.js',
		VMLRadialGradientURL: 'https://code.highcharts.com/stock/2.0.4/gfx/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
