/* https://keith-wood.name/datepick.html
   ...
   Requires Jörn Zaefferer's Validation plugin (https://plugins.jquery.com/project/validate).
   Written by Keith Wood (kbwood{at}iinet.com.au).
   Licensed under the MIT (https://keith-wood.name/licence.html) licence. 
