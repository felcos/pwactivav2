...
set xxvideo = Server.CreateObject("ADODB.Recordset")
sqlvideo = "SELECT Id, Fecha, Link, Descrip, Mailing, PWhoy FROM VideosLists where Mailing=1 ORDER BY fecha DESC"
xxvideo.Open sqlvideo, session("connPW")	',1,1
...
<head>
    ...
    <style>
        .dialogbox1{
            background: url(/_inc/javier/mailing/ventana1x.png);
            position: absolute; left: 321px; top: 1px; z-index: 2;
            width: 150px;height: 100px;
        }
        .dialogbox2{
            background: url(/_inc/javier/mailing/ventana2.png);
            align-self: center;
        ...
        .dialogbox3{
            background: url(/_inc/javier/mailing/ventana3.png);
            align-self: center;
...
<table width="100%" bgcolor="#f7f7f7" border="0" cellpadding="0" cellspacing="0">
  ...
  <td align="center">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="width: 100%; max-width: 970px;">
        <tr>
            <td><!--1-->
            	<img src="/_inc/javier/mailing/cabecera-new.jpg" usemap="#cabecera" border="0" /><!--cabecera-sin.gif -->
            </td>
</tr>
...
<table width="100%" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
    ...
    <tr>
        <h2 style="font-size: smaller;" class="tit_box"><span class="icon icon-arrow-down-right2"></span>Si aun no estas suscrito y deseas suscribirte o recibir un demo para conocer producto haz clic <a href="mailto:administracion@propertyweb.eu">aquí</a></h2>
...
<td>
<a href="https://www.catella.com/" target="_blank" ><img src="/img/Catella.gif" align="right"/></a> 
<br>
</td>
<td>
<a href="https://www.dracorion.com/" target="_blank" ><img src="/img/Dracorion.gif" align="right"/></a> 
<br>
</td>
 <td>
  <a href="https://www.simmons-simmons.com/" target="_blank" ><img src="/img/simmons.gif" align="right"/></a> 
  <br>
 </td>
 <td>
  <a href="https://inmobiliaria.cushmanwakefield.es/" target="_blank" ><img src="/img/Cus.png" align="right"/></a> 
  <br>
 </td>
<td>
  <a href="https://www.gleeds.com/en/" target="_blank" ><img src="/img/gleeds.gif" align="right"/></a> 
  <br>
 </td>
    </tr>
...
<%
dim linkvideo
linkvideo="htttp://www.propertyweb.eu" 
if not xxvideo.eof then

linkvideo=xxvideo("link")
%>
<% end if %>
</table>
...
<table width="100%" bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" class="bloque" >
    <span style="color:#2b4e61;font-size:18px;">Andy da las claves de Hoy en vivo!</span>
    <tr>
        <td style="padding:16px; padding-top:6px"><a href="https://youtu.be/<%=linkvideo %>"><img src="video03.png" hspace="20" ></a></td>
   </tr>
...
<table width="100%" bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" class="bloque" >
     <caption align="top" style="font-size:21px; color:#FF6802; text-align:left; font-family:Verdana, Geneva, sans-serif">
     	<img src="/_inc/javier/mailing/boloH1.gif"  /> Empresas ¿quizas? buscando oficinas</caption>
     <tr>
...
<table >
    ...
    <tr>
        <td >
               <a href="https://www.propertyweb.eu/actualidad/"><img src="/_inc/javier/mailing/ventana4.png"></a> 
        </td>
   </tr>
</table>
<!-- buscar : FIN -->
...
<table width="100%" bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" class="bloque" >
    <caption align="top" style="font-size:21px; color:#FF6802; text-align:left; font-family:Verdana, Geneva, sans-serif">
        <img src="/_inc/javier/mailing/boloH1.gif"  /> Ops Inversión publicadas en enero 2026 </caption>
    <tr>
        <td style="padding:16px; padding-top:6px"><!--#include virtual="/mailing/uso.htm" --></td>
   </tr>
</table>
<table width="100%" bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" class="bloque" >
    <caption align="top" style="font-size:21px; color:#FF6802; text-align:left; font-family:Verdana, Geneva, sans-serif">
        <img src="/_inc/javier/mailing/boloH1.gif"  /> Ops Alquiler publicadas en enero 2026 </caption>
    <tr>
        <td style="padding:16px; padding-top:6px"><!--#include virtual="/mailing/alq.htm" --></td>
   </tr>
</table>
<!-- OPSMES : FIN -->
...
<table width="100%" bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" class="bloque" >
     <caption align="top" style="font-size:21px; color:#FF6802; text-align:left; font-family:Verdana, Geneva, sans-serif">
     	<img src="/_inc/javier/mailing/boloH1.gif"  /> Publicidad </caption>
     <tr>
     	<td style="padding:16px; padding-top:6px">
<table width="100%"  border="0" cellpadding="0" cellspacing="0" style="width: 100%">
    <tr>
        <td align="right" style="width: 236px">
            <a href="https://www.eco-house.es/" target="_new"><img src="/img/chalet.jpg" width="387" height="133" style="border: 0px;"></a>
        </td>
    </tr>
</table>
		</td>
...
<table width="100%" bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" class="bloque" >
   <tr>
    <td >    <span style="color:#2b4e61;font-size:18px;"><img src="/_inc/javier/mailing/icono-loc.png" width="56" style="width: 56;">&nbsp;Principe de Vergara 110, Madrid</span>
    </td>
   </tr> 
   <tr>
    <td  style="padding:16px; padding-top:6px"><a href="https://www.propertyweb.eu/flash2"><img src="/_inc/javier/mailing/cpv1102.gif" hspace="20" ></a></td>
   ...
   <tr>
    <td style="padding:16px; padding-top:6px">
        ...
        <a style="color: #ff6701;" href="https://www.propertyweb.eu/articulos/?ope=34538&seltipo=edif&frmInfo_tipo=edif&frmInfo_busq=principe%20de%20vergara&historico_alquiler=on&historico_inversion=on&historico_noticias=on&historico_rumores=on&historico_estudios=on&secc=edif&origen=edif:5093&id_edificio=5093&edificio=PRINCIPE%20DE%20VERGARA%20110&calle=PRINCIPE%20DE%20VERGARA&l=MADRID&numerocalle=110&d=CALLE%20PRINCIPE%20DE%20VERGARA%20110"  >
            <span style="color: #ff6701;" class="icon-newspaper"></span><input type="button" value="&nbsp;¿Quieres saber que ha pasado?" />
        </a>
            
        <a style="color: #ff6701;" href="https://www.propertyweb.eu/dealanalysis/default.asp?xOrigen=1" ><div class="inm_nombre"><span style="color: #ff6701;" class="icon-equalizer"></span><input type="button" value="&nbsp;¿Quieres saber que operaciones hay en la zona?" /></a>
