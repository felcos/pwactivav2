...
'currYear
sql = "SELECT *, CONVERT(VARCHAR(10), fecha, 121) AS ff FROM regFechas('2015-01-01', '2015-05-01')"
...
'prevYear
sql = "SELECT *, CONVERT(VARCHAR(10), fecha, 121) AS ff FROM regFechas('2014-01-01', '2014-05-01')"
rs.Open sql, session("connPWAcesos")
