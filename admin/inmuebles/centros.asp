...
%>
    <div class="grid-half titulo">
        <h1 class="heading">Centros Comerciales</h1>
	</div>
...
<div class="dev mini" style="display:none;">
    ...
    <input type="text" name="cc" value="1"/>
...
<input value="buscar" type="submit"> &nbsp; <input value="reset" type="button" onClick="location.assign('/admin/inmuebles/centros.asp');">
</div>
	</div>
</form>
</section>
