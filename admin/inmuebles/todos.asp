...
<div class="dev mini" style="display:none;">
    <div style="float:left; width:60px;">buscando: </div><div id="dev_buscando" style="margin-left:5px; float:left; min-height:1em; width:90px;">&nbsp;</div>
    <div style="float:left; width:60px;">qry_count: </div><div id="dev_qry_count" style="margin-left:5px; float:left;">0</div>
    <div style="clear:both;"></div>
    <div style="float:left; width:60px; margin-left:155px;">qry_tries: </div><div id="dev_qry_tries" style="margin-left:5px; float:left;">0</div>
    <div style="clear:both;"></div>
    <div id="dev_informa"></div>
</div>
<div class="dev mini" style="display:none;">
...
<div style="margin-top:9px; margin-bottom:6px;">
    <div class="row">
	    <label>Tiene:</label>
    </div>
    ...
    <select name="tiene_latlng" style="border:none;">
      ...
      <option value="*" selected>*</option>
    	...
    	<div class="grid-2" style="margin-bottom:4px;">
    Coords.:&nbsp;
    <select name="tiene_coords" style="border:none;">
      <option value="1">s&iacute;</option>
    ...
    <div class="row">
        ...
        Disponib.:&nbsp;
        <select name="tiene_disponibl" style="border:none;">
          <option value="1">s&iacute;</option>
          <option value="0">no</option>
          <option value="*" selected>*</option>
        </select>
        ...
        <div class="grid-2" style="margin-bottom:0;">
        Plantas.:&nbsp;
        <select name="tiene_plantas" style="border:none;">
          <option value="1">s&iacute;</option>
          <option value="0">no</option>
          <option value="*" selected>*</option>
        </select>
        </div>
    	<div class="grid-2" style="margin-bottom:0;">[ top: <input type="checkbox" name="top" value="1" <% if val_top then %>checked<% end if %>/> ]</div>
    </div>
	
    <div class="row" style="margin-top:12px;">
        <label>Mostrar:</label>
        <input type="checkbox" name="edif" id="map_edif" value="1" <% if val_edif then %>checked<% end if %>/>
        <label for="map_edif">Edificios&nbsp;</label>
        <input type="checkbox" name="cc" id="map_cc" value="1" <% if val_cc then %>checked<% end if %>/>
        <label for="map_cc">Centros Comerciales</label>
        <input type="checkbox" name="hotel" id="map_hotel" value="1" <% if val_hotel then %>checked<% end if %>/>
        <label for="map_hotel">Hoteles</label>
	</div>
</div>
<div style="margin: 0 0 5px 0; display:none;">
...
<input value="buscar" type="submit"> &nbsp; <input value="reset" type="button" onClick="location.assign('/admin/inmuebles/todos.asp');">
</div>
	</div>
</form>
</section>
...
<tr>
    ...
    <th align="left">inmuebles &nbsp; <span id="contador_articulos"></span></th>
...
<section id="informa" class="cf" style="margin-top:6px; margin-bottom:6px; display:Znone;">
