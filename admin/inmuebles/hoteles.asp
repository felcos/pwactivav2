...
<div class="dev mini" style="display:none;">
    ...
    <input type="text" name="hotel" value="1"/>
...
<div style="margin: 18px 0 18px 0;">
	...
	<div class="grid-4">
<div style="margin: 8px 0 8px 85px;">

<label for="busq">Buscar:</label>
<input id="busq" class="grande" type="text" name="busq" value="<%= busqueda %>" autofocus maxlength="50" />
...
<input value="buscar" type="submit"> &nbsp; <input value="reset" type="button" onClick="location.assign('/admin/inmuebles/hoteles.asp');">
</div>
	</div>
</form>
</section>
...
<tr>
    ...
    <th style="font-weight:normal; font-size:10px; width:30px;">dir</th>
    <th style="font-weight:normal; font-size:10px; width:30px;">lat/lng</th>
</tr>
</thead>
</table>
        </div>
...
<div class="grid-1" align="center"><a href="#" class="clearmap peq">clear</a></div>
...
<input id="pac-input" class="controls" type="text" placeholder="buscar">
        ...
        <div id="informa_mapa" class="peq" style="display:Znone;">
