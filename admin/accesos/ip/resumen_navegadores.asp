...
<tr>
    ...
    <% end if %>
    <td><strong>http_user_agent</strong><span class="peq" style="float:right;"><% if procesar then %><a href="/admin/accesos/ip/resumen_navegadores.asp?ip=<%= ip %>" target="_blank" id="recargar">http_user_agent</a><% else %><a href="/admin/accesos/ip/resumen_navegadores.asp?ip=<%= ip %>&procesar=true" target="_blank" id="recargar">procesar</a><% end if %></span></td>
</tr>
<% do while not rs.eof 
