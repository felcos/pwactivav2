...
$(document).ready(function() {
  ...
  <% if request.Form("ordenando")="" then %>
	...
	<% if counter>0 then %>
		$("#informa_resultados .tit_metros").html(", con <%= FormatNumber(total_superficie_p, 0) %> m&sup2; en Proyecto, y <%= FormatNumber(total_superficie-total_superficie_p, 0) %> m&sup2; Disponibles hoy, para un total de <%= FormatNumber(total_superficie, 0) %> m&sup2;");
	<% else %>
...
sub Linea()	
	...
	%>
<div class="dispA" data-id="<%= rsBusq("id") %>" <% if c_fecha_edif>10000 then 
