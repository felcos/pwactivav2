...
<form id="frm_preguntas" class="filtrosForm" action="/disponibilidad2/data/ajax.asp" method="post" target="_blank">
...
<div class="form-group">
	...
	<input type="text" id="ciudad-filtro" name="ciudad" class="form-control" placeholder="Ej. Madrid" autocomplete="off" value="Madrid"><!--  onchange="CambiaLocalidad();" -->
